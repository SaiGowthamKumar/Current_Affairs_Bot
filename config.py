...
GROQ_MAX_SUMMARIES_PER_RUN = _get_env_int("GROQ_MAX_SUMMARIES_PER_RUN", 4)
GROQ_MIN_SECONDS_BETWEEN_CALLS = _get_env_float("GROQ_MIN_SECONDS_BETWEEN_CALLS", 4.0)
GROQ_429_BACKOFF_SECONDS = _get_env_float("GROQ_429_BACKOFF_SECONDS", 20.0)
